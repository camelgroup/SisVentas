...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::open(array('url'=>'almacen/articulo','method'=>'POST','files'=>'true','autocomplete'=>'off'))!!}
            {{Form::token()}}
						<div class="row">
							...
							<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
								<div class="form-group">
									...
									<input type="number" min="0" name="stock"  Required value="{{old('stock')}}" class="form-control" placeholder="Stock del artículo...">
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
								<div class="form-group">
